...
export function fontFamily(name = '') {
  ...
  if (/liberationserif|dejavuserif|nimbusroman|freeserif|timesnewroman|tinos|^times/.test(fam)) family = 'Times New Roman'
  else if (/liberationmono|dejavusansmono|couriernew|cousine|^courier/.test(fam)) family = 'Courier New'
  else if (/liberationsans|dejavusans|nimbussans|freesans|arimo|^arial/.test(fam)) family = 'Arial'   // same mapping as pdfLayout.mjs; arimo/tinos/cousine are Croscore metric clones (Typst, ChromeOS)
